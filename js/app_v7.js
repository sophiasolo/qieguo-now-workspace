...
function generateCopyAI(){
  ...
  var huaZiIntro=''+
    '🌡️热到不想动｜🧊打败高温的快乐｜💼工作日的解暑方案｜'+
    '😆周五福来day｜周末宅家公式=沙发🛋️+空调❄️+｜'+
    '🛵外卖专享｜⚡限时特价｜⋆⁺₊☾ 周六限定｜'+
    '一周过半⏳该奖励自己了｜🤔今日诊断：你缺一份鲜果切｜'+
    '一周的仪式感从今天开始✨';
  ...
  var sellIntro=''+
    '麒麟瓜正值甜度巅峰🍉冰甜多汁｜蜜甜脆爽🍈冰镇绝了｜'+
    '肉厚核薄🥭甜到心里｜酸甜刚好🍍不涩口｜'+
    '当季鲜切🍉冰一下更好吃';
  
  var prompt='你是切果NOW品牌社群文案专家，务必模仿以下写作风格。\\n\\n'+
    '【品牌调性】鲜切水果外卖，健康活力、口语化亲切、不浮夸。朋友圈/微信群文案。\\n\\n'+
    '【花字开场示例】'+huaZiIntro+'\\n\\n'+
    '【CTA收尾示例】'+ctaIntro+'\\n\\n'+
    '【品类卖点示例】'+sellIntro+'\\n\\n'+
    '【格式铁律】每行≤20字｜行尾必加emoji｜不用{}【】等符号做标题｜花字开头要有创意感｜CTA结尾要有行动号召｜中间穿插产品卖点｜语气像朋友聊天不是广告\\n\\n'+
    '【推送日】'+dayName+'\\n'+
    '【产品名】'+product+'\\n'+
    '【价格】'+(price||'各区域以平台实际为准')+'\\n'+
    '【配送】'+delivery+'\\n'+
    '【方向】'+(direction==='auto'?'根据推送日自由选择':direction)+'\\n\\n'+
    '生成3版差异化的社群文案，每版5-8行，风格要有明显区别，花字不重复。\\n'+
    '输出格式（严格）：\\n'+
    '【版本一 · 风格名】\\n文案\\n\\n'+
    '【版本二 · 风格名】\\n文案\\n\\n'+
    '【版本三 · 风格名】\\n文案';
