...
function getCardCats(){
  return {
    '谐音梗': ['接粽而来','瓜目相看','甜你一夏','柚你真好','芒里偷闲','萄你喜欢','樱有尽有','桃不开你','李想生活','椰椰椰'],
    'Unicode': ['𝐒𝐚𝐭𝐮𝐫𝐝𝐚𝐲','𝗠𝗼𝗻𝗱𝗮𝘆 𝗣𝗶𝗰𝗸','𝙝𝙚𝙡𝙡𝙤 𝙨𝙪𝙢𝙢𝙚𝙧','𝑭𝒓𝒖𝒊𝒕 𝑻𝒊𝒎𝒆','🍉⋆｡°✩ 西瓜×夏天=快乐','🍍⋆⭒˚｡ 菠萝海浪','🥭.ೃ࿔*:･ 芒果味日常'],
    '公式体': ['鲜果+冰爽=周一不丧🍉','高温×果切-热量=快乐²','周末快乐公式🧊西瓜汁+果切+沙发=躺平','🍉 夏天=空调+西瓜+追剧','🍍 快乐=菠萝×冰镇×无限'],
    'emoji串': ['😴➡🍉😋 .ᐟ.ᐟ','🥱😪➡😋🤩✨','⋆⁺🧊🍃 Summer ꙳','🍉☀️💦✨ 夏天正确打开','🍍🌊🏖️🥥 海岛风情'],
    '诊断/处方体': ['🤔今日诊断：缺一份鲜果切','📋今日处方：冰镇西瓜×1 即刻服用','🩺诊断：缺少维生素C','💊处方：一斤西瓜见效','🩺确诊：下午3点犯困症','💊处方：冰镇凤梨一份'],
    '限时信号': ['⚡今日限定','⏰倒计时','🔥仅此一天','⏰限时预警：下午茶到','🔔友情提示：不下单等明年'],
    '菜单/小票体': ['🧾今日推荐','━━━━━ 🍉招牌鲜果切 💰特价','📋外卖必点清单','▪ TOP1 一斤西瓜','▪ TOP2 凤梨乌梅'],
    '搜索/弹幕体': ['🔍正在搜索：周末吃什么…','🔍搜索切果NOW→发现新大陆','🔍全城热搜No.1→冰镇西瓜']
  };
}
