...
function getCardCats(){
  return {
    '谐音梗': ['接粽而来','瓜目相看','甜你一夏','柚你真好','芒里偷闲','萄你喜欢','樱有尽有','桃不开你','🍉 吃瓜群众已就位','💚 从此对瓜改观','🍊 橙意满满的周二','💛 周二就要芒起来'],
    'Unicode': ['𝐒𝐚𝐭𝐮𝐫𝐝𝐚𝐲','𝗠𝗼𝗻𝗱𝗮𝘆 𝗣𝗶𝗰𝗸','𝙝𝙚𝙡𝙡𝙤 𝙨𝙪𝙢𝙢𝙚𝙧','🍉⋆｡°✩ 西瓜×夏天=快乐','🍍⋆⭒˚｡ 菠萝海浪打在舌尖','🍈 果香是夏天的入场券'],
    '公式体': ['鲜果+冰爽=周一不丧🍉','高温×果切-热量=快乐²','🍉 夏天=空调+西瓜+追剧','🍍 快乐=菠萝×冰镇×无限','🥭 好心情=芒果+酸奶+你'],
    'emoji串': ['😴➡🍉😋 .ᐟ.ᐟ','🥱😪➡😋🤩✨','⋆⁺🧊🍃 Summer꙳','🍉☀️💦✨ 夏天打开方式','🍍🌊🏖️🥥 海岛风情来一套'],
    '诊断/处方体': ['🤔今日诊断：缺一份鲜果切','📋今日处方：冰镇西瓜即刻服用','🩺诊断：缺少维生素C','💊处方：一斤西瓜见效','🩺确诊：下午犯困症','💊处方：冰镇凤梨'],
    '限时信号': ['⚡今日限定','⏰倒计时','🔥仅此一天','⏰限时预警：下午茶到','🔔友情提示：不下单等明年'],
    '菜单/小票体': ['🧾今日推荐','━━ 🍉招牌鲜果切 💰特价','📋今日菜单：招牌四拼+冰镇西瓜','📋外卖必点：TOP1一斤西瓜'],
    '搜索/弹幕体': ['🔍正在搜索：周末吃什么','🔍搜索切果NOW→发现新大陆','🔍全城热搜No.1→冰镇西瓜','🔍离快乐只差一个搜索']
  };
}
